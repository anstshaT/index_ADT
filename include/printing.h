 ...
 */
  ...
  *
  * Prefix format: `[PANIC][__FILE__:__LINE__] @__func__ > ...`
  *
 ...
 #  define PANIC(fmt, ...)                                                                              \
         do {                                                                                           \
             do_print_if_lvl(LOG_LEVEL_PANIC, stderr,                                                   \
                             COLOR_META                                                                 \
                             "[PANIC]" META_FILE_LINE_FMT META_FUNC_FMT COLOR_PR_ERROR fmt COLOR_RESET, \
  ...
  *
  * Prefix format: `[error][__FILE__:__LINE__] @__func__ > ...`
  *
  ...
  *
  * Prefix format: `[__FILE__:__LINE__] ...`
  *
  * @note omitted if `LOG_LEVEL != LOG_LEVEL_DEBUG` or `NDEBUG` is defined.
  */
 #    define pr_debug(fmt, ...)                                                                               \
           do_print_if_lvl(LOG_LEVEL_DEBUG, stderr,                                                           \
                           COLOR_META META_FILE_LINE_FMT COLOR_PR_DEBUG fmt COLOR_RESET, META_FILE_LINE_ARGS, \
                           ##__VA_ARGS__)
